...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="/root/verl/data/math/")
    parser.add_argument("--hdfs_dir", default=None)
    parser.add_argument("--model", default="Qwen2.5-1.5B", choices=["Qwen2.5-1.5B", "Qwen2.5-3B", "Qwen2.5-7B", "other"])
